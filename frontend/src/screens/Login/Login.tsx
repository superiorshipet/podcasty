...
export const Login = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Parse error message - handle both JSON and plain text errors
        ...
        <div className="flex flex-col w-full items-start gap-6 p-6 bg-white rounded-lg border-[0.8px] border-solid border-[#0000001a] shadow-md">
          ...
          <form className="flex flex-col w-full items-start gap-4" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="all-[unset] box-border bg-[#8b22b0] relative self-stretch w-full h-9 rounded-lg text-white text-center [font-family:'Arimo',Helvetica] disabled:opacity-50 cursor-pointer hover:bg-[#7a1d9c]"
            >
